...
var list=$(".titleInput").val()
            $('table').append( ' <tr><td>'+list+'</td><td>'+$(".rate").val()+'</td><td><button  id= "btnDelete">  Delete </button></td></tr>')
...
alert('Please add raiting number or Movie title')
    }
